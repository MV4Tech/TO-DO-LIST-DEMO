...
import ResolvedTaskModal from "./adminResolvedHeaderTaskModal.jsx";
import '../../styles/dashboard.css';
import TaskModal from './adminTaskModal.jsx'
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-5 ">            
              <div className="py-5 px-4 masthead-cards">
                ...
                <TaskModal/>             
                  <a onClick={() => navigate("/adminProfile")} style={{ cursor: 'pointer' }}  className="w-50 pl-3 pb-4 p-2">
                ...
                <div className="d-flex">
                  <a onClick={()=>navigate("/adminPage")} style={{ cursor: 'pointer' }}  className="w-50 pr-3 p-2">
                    <div className="card border-0 border-bottom-yellow shadow-lg shadow-hover">
                      <div className="card-body text-center">
                        <div className="text-center">
                          <i className="fa fa-4x fa-wrench my-2"></i>
                        </div>
                        ADMIN
                      </div>
                    </div>
